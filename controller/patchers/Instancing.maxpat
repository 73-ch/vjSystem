...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1287.0, 478.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1290.0, 387.0, 55.0, 22.0 ],
					"text" : "r volume"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 629.0, 527.0, 41.0, 22.0 ],
					"text" : "pow 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 590.63818359375, 716.5, 39.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 875.0, 511.0, 39.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 909.114501953125, 472.0, 59.0, 22.0 ],
					"text" : "random 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 924.161865234375, 435.0, 81.0, 22.0 ],
					"text" : "r audio_event"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 38.0, 528.0, 56.0, 22.0 ],
					"text" : "+ 0.0001"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1028.0, 13.0, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1028.0, 234.0, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 346.0, 448.0, 36.0, 22.0 ],
					"text" : "+ 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 248.0, 410.0, 55.0, 22.0 ],
					"text" : "r volume"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 650.0, 472.0, 33.0, 22.0 ],
					"text" : "* 0.7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 18.399999618530273, 453.0, 40.0, 22.0 ],
					"text" : "* 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 590.63818359375, 617.0, 41.0, 48.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 108.0, 403.0, 41.0, 48.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"addpoints_with_curve" : [ 0.0, 0.0, 0, 0.0, 273.03247103349122, 3.76800012588501, 2, 0.0, 419.175908110622458, 6.091600203514099, 2, 0.0, 538.255745729025762, 1.25600004196167, 0, 0.0, 676.280102968538586, 1.004800033569336, 2, 0.0, 868.431659125507394, 3.202800107002258, 2, 0.0, 871.138019071380199, 0.18840000629425, 0, 0.0, 949.622457501691429, 0.439600014686584, 2, 0.0, 1000.0, 0.0, 0, 0.0 ],
					"id" : "obj-88",
					"maxclass" : "function",
					"mode" : 1,
					"numinlets" : 1,
					...
					"outlettype" : [ "float", "", "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 903.114501953125, 70.0, 381.5, 125.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 556.13818359375, 308.0, 175.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 590.63818359375, 790.5, 67.0, 22.0 ],
					"text" : "s osc-send"
				}
...
, 			{
				"box" : 				{
					"addpoints_with_curve" : [ 0.0, 0.0, 0, 0.0, 152.627913678278702, 4.491944594515695, 0, 0.0, 311.097859033469945, 1.395555602179633, 0, 0.0, 488.693487448770497, 4.230277919107014, 0, 0.0, 674.485837175546408, 0.218055562840568, 0, 0.0, 964.103323514344311, 1.657222277588315, 0, 0.0, 1000.0, 6.28000020980835, 0, 0.0 ],
					"id" : "obj-20",
					"maxclass" : "function",
					"mode" : 1,
					"numinlets" : 1,
					...
					"outlettype" : [ "float", "", "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 782.13818359375, 228.0, 378.0, 169.0 ],
					"range" : [ 0.0, 6.28000020980835 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_shortname" : "function",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 628.13818359375, 500.5, 93.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 628.13818359375, 561.5, 162.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "", "", "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 31.2144775390625, 171.0, 181.0, 80.0 ],
					"range" : [ 0.0, 6.28000020980835 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_shortname" : "function",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 527.0, 251.20001220703125, 184.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 27.914478302001953, 137.400001525878906, 517.66448974609375, 137.400001525878906, 517.66448974609375, 65.0, 912.614501953125, 65.0 ],
					"order" : 0,
					"source" : [ "obj-15", 0 ]
				}
